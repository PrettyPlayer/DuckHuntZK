...
while True:
    ...
    if 60==random.randint(1,120):
        ran1=random.randint(0,1)
        dirx=ran1
    if 120==random.randint(1,120):
    ...
    if pygame.mouse.get_focused():
        ...
        pygame.draw.line(surf_main, RED, (pos[0], pos[1] + mouse_start_len), (pos[0], pos[1] + mouse_start_len + mouse_len), mouse_thickness)
        pygame.draw.line(surf_main, RED, (pos[0], pos[1] - mouse_start_len), (pos[0], pos[1] - mouse_start_len - mouse_len), mouse_thickness)
        pygame.draw.line(surf_main, RED, (pos[0] + mouse_start_len, pos[1]), (pos[0] + mouse_start_len + mouse_len, pos[1]), mouse_thickness)
        pygame.draw.line(surf_main, RED, (pos[0] - mouse_start_len, pos[1]), (pos[0] - mouse_start_len - mouse_len, pos[1]), mouse_thickness)
    pygame.display.update()
    time_img+=1
    time_die+=1